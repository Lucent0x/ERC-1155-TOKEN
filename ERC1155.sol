...
/// @custom:security-contact mail.lucidity@gmail.com
contract CodegodToken is
    ERC1155,
    AccessControl,
    ERC1155Burnable,
    ERC1155Supply
{
    ...
    constructor()
        ERC1155(
            "https://bafybeihuf2w237imsll2tyyeurt2jbaw23i2www3nv67snluuqiwrn3zc4.ipfs.nftstorage.link/{0}.json"
        )
    {
        ...
        _mint(msg.sender, 1, 10000 * 10 ** 18, "data");
    }
    ...
    function uri(uint256 tokenId) public pure override returns (string memory) {
        return (
            string(
                abi.encodePacked(
                    "https://bafybeihuf2w237imsll2tyyeurt2jbaw23i2www3nv67snluuqiwrn3zc4.ipfs.nftstorage.link/",
